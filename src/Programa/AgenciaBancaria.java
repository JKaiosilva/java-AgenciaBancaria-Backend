...
public class AgenciaBancaria {
	...
	public static void operacoes() {
		...
		case 5:
			...
			break;
		case 6:
			System.out.println("Finalizando acesso.");
			System.exit(0);
	...
	public static void transferir() {
		...
		Conta contacontaRemetente = encontrarConta(numeroContaRemetente);
		
		if(contacontaRemetente != null) {
			...
			if(contaDestinatario != null) {
				...
				contacontaRemetente.transferir(contaDestinatario, valor);
			}
		}else {
			System.out.println("Conta não encontrada");
		}
